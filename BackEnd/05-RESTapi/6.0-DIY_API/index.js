...
app.get('/jokes/:id',(req,res)=>{
  //req.params string type ki value lotate
  let id=req.params.id;
  //yha double equal se is liye check kia kyu dono ki type diff jb k value same hai
...
app.get('/filter',(req,res)=>{
  ...
  let jokesArr=jokes.filter((joke)=>joke.jokeType===type);
  res.json(jokesArr)
});
//4. POST a new joke
...
app.put('/jokes/:id',(req,res)=>{
  ...
  console.log(jokes.find((joke)=>joke.id==id))
  res.json(newJoke);
})
//6. PATCH a joke
...
app.delete('/all',(req,res)=>{
  ...
  if(userKey===masterKey){
    ...
    res.status(404).json({error:'You fialed in authentication'})
  }
})
app.listen(port, () => {
